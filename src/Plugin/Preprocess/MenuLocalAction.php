...
/**
 * @file
 * Contains \Drupal\sage\Plugin\Preprocess\MenuLocalAction.
 */
 ...
 */
class MenuLocalAction extends \Drupal\bootstrap\Plugin\Preprocess\MenuLocalAction {
  ...
  public function preprocessElement(Element $element, Variables $variables) {
    ...
    $icon = Sage::faiconFromString($link['title']);
    ...
    if (isset($link['url'])) {
      ...
      $options['attributes']['class'][] = 'btn-labeled';
      $options['attributes']['class'][] = 'btn-xl';
